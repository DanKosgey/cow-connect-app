-- Apply the batch approval fix directly in Supabase SQL Editor
-- This is the same fix as in the migration file but can be run directly
...
BEGIN
    ...
    RETURN QUERY SELECT 
        ...
        v_total_collected AS total_liters_collected,
        v_total_received AS total_liters_received,
        v_total_variance AS total_variance,
        v_total_penalty AS total_penalty_amount,
        CASE 
