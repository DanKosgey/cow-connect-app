...
DROP POLICY IF EXISTS "Admins can read farmer_credit_profiles" ON public.farmer_credit_profiles;
DROP POLICY IF EXISTS "Admins can insert farmer_credit_profiles" ON public.farmer_credit_profiles;
DROP POLICY IF EXISTS "Admins can update farmer_credit_profiles" ON public.farmer_credit_profiles;
DROP POLICY IF EXISTS "Admins can delete farmer_credit_profiles" ON public.farmer_credit_profiles;

CREATE POLICY "Admins can read farmer_credit_profiles" 
...
CREATE POLICY "Admins can insert farmer_credit_profiles" 
...
CREATE POLICY "Admins can update farmer_credit_profiles" 
  ON public.farmer_credit_profiles FOR UPDATE 
  TO authenticated
  USING (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
CREATE POLICY "Admins can delete farmer_credit_profiles" 
  ON public.farmer_credit_profiles FOR DELETE 
  TO authenticated
  USING (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
DROP POLICY IF EXISTS "Admins can read farmer_credit_limits" ON public.farmer_credit_limits;
DROP POLICY IF EXISTS "Admins can insert farmer_credit_limits" ON public.farmer_credit_limits;
DROP POLICY IF EXISTS "Admins can update farmer_credit_limits" ON public.farmer_credit_limits;
DROP POLICY IF EXISTS "Admins can delete farmer_credit_limits" ON public.farmer_credit_limits;

CREATE POLICY "Admins can read farmer_credit_limits" 
...
CREATE POLICY "Admins can insert farmer_credit_limits" 
  ON public.farmer_credit_limits FOR INSERT 
  TO authenticated
  WITH CHECK (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
CREATE POLICY "Admins can update farmer_credit_limits" 
  ON public.farmer_credit_limits FOR UPDATE 
  TO authenticated
  USING (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
CREATE POLICY "Admins can delete farmer_credit_limits" 
  ON public.farmer_credit_limits FOR DELETE 
  TO authenticated
  USING (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
DROP POLICY IF EXISTS "Admins can read farmer_credit_transactions" ON public.farmer_credit_transactions;
DROP POLICY IF EXISTS "Admins can insert farmer_credit_transactions" ON public.farmer_credit_transactions;
DROP POLICY IF EXISTS "Admins can update farmer_credit_transactions" ON public.farmer_credit_transactions;
DROP POLICY IF EXISTS "Admins can delete farmer_credit_transactions" ON public.farmer_credit_transactions;

CREATE POLICY "Admins can read farmer_credit_transactions" 
...
CREATE POLICY "Admins can insert farmer_credit_transactions" 
  ON public.farmer_credit_transactions FOR INSERT 
  TO authenticated
  WITH CHECK (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
CREATE POLICY "Admins can update farmer_credit_transactions" 
  ON public.farmer_credit_transactions FOR UPDATE 
  TO authenticated
  USING (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
CREATE POLICY "Admins can delete farmer_credit_transactions" 
  ON public.farmer_credit_transactions FOR DELETE 
  TO authenticated
  USING (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
DROP POLICY IF EXISTS "Admins can read credit_requests" ON public.credit_requests;
DROP POLICY IF EXISTS "Admins can insert credit_requests" ON public.credit_requests;
DROP POLICY IF EXISTS "Admins can update credit_requests" ON public.credit_requests;
DROP POLICY IF EXISTS "Admins can delete credit_requests" ON public.credit_requests;

CREATE POLICY "Admins can read credit_requests" 
...
CREATE POLICY "Admins can insert credit_requests" 
...
CREATE POLICY "Admins can update credit_requests" 
...
CREATE POLICY "Admins can delete credit_requests" 
...
DROP POLICY IF EXISTS "Admins can read payment_statements" ON public.payment_statements;
DROP POLICY IF EXISTS "Admins can insert payment_statements" ON public.payment_statements;
DROP POLICY IF EXISTS "Admins can update payment_statements" ON public.payment_statements;
DROP POLICY IF EXISTS "Admins can delete payment_statements" ON public.payment_statements;

CREATE POLICY "Admins can read payment_statements" 
...
CREATE POLICY "Admins can insert payment_statements" 
  ON public.payment_statements FOR INSERT 
  TO authenticated
  WITH CHECK (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
CREATE POLICY "Admins can update payment_statements" 
  ON public.payment_statements FOR UPDATE 
  TO authenticated
  USING (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
CREATE POLICY "Admins can delete payment_statements" 
  ON public.payment_statements FOR DELETE 
  TO authenticated
  USING (EXISTS (
    SELECT 1 FROM public.user_roles ur 
    WHERE ur.user_id = auth.uid() AND ur.role = 'admin' AND ur.active = true
...
DROP POLICY IF EXISTS "Admins can read market_prices" ON public.market_prices;
DROP POLICY IF EXISTS "Admins can insert market_prices" ON public.market_prices;
DROP POLICY IF EXISTS "Admins can update market_prices" ON public.market_prices;
DROP POLICY IF EXISTS "Admins can delete market_prices" ON public.market_prices;

CREATE POLICY "Admins can read market_prices" 
...
CREATE POLICY "Admins can insert market_prices" 
...
CREATE POLICY "Admins can update market_prices" 
...
CREATE POLICY "Admins can delete market_prices" 
