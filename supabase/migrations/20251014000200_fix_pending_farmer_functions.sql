-- Migration: 20251014000200_fix_pending_farmer_functions.sql
-- Description: Fix approve_pending_farmer and reject_pending_farmer functions to use correct status values
...
-- Fix approve_pending_farmer function to use correct status values (keep original parameter names)
...
-- Fix reject_pending_farmer function to use correct status values (keep original parameter names)
...
-- Recreate original functions with p_ prefix parameters
-- (Original functions would be restored here)
