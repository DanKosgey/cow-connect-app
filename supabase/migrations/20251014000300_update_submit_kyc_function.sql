-- Migration: 20251014000300_update_submit_kyc_function.sql
-- Description: Update submit_kyc_for_review function to use correct status values
...
-- Update submit_kyc_for_review function to use correct status values
...
BEGIN
    ...
    -- Check if documents are already submitted for review (status should be 'submitted' not 'email_verified')
