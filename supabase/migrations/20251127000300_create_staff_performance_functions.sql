-- Migration: 20251127000300_create_staff_performance_functions.sql
-- Description: Create functions to calculate and update staff performance metrics
...
BEGIN
  ...
  WHERE ma.staff_id = p_staff_id
    AND ma.created_at >= p_period_start
    AND ma.created_at <= p_period_end;
