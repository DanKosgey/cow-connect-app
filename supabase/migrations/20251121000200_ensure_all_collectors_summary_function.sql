-- Migration: 20251121000200_ensure_all_collectors_summary_function.sql
-- Description: Ensure the get_all_collectors_summary function exists with correct definition
-- This fixes the 404 error when calling the RPC function

BEGIN;

-- Drop the function if it exists with incorrect signature
DROP FUNCTION IF EXISTS public.get_all_collectors_summary();
