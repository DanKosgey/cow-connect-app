-- Migration: 20251117180000_create_collector_performance_table.sql
-- Description: Create collector_performance table for tracking collector performance metrics
-- Estimated time: 1 minute

BEGIN;

-- Create collector_performance table
CREATE TABLE IF NOT EXISTS public.collector_performance (
  ...
  approved_collections INTEGER DEFAULT 0,
  rejected_collections INTEGER DEFAULT 0,
  pending_collections INTEGER DEFAULT 0,
