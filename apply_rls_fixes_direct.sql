-- RLS Policy Fixes for Recursion Issues
-- This script fixes all RLS policies that were causing "infinite recursion detected in policy for relation 'user_roles'"
