    ...
    <div className="flex flex-col h-full bg-gradient-to-b from-slate-900/95 to-slate-950/95 rounded-xl border border-emerald-500/20 shadow-2xl backdrop-blur-sm relative overflow-hidden">
      ...
      <ScrollArea className="flex-1 p-4">
        <div className="space-y-6">
          ...
          {isLoading && (
            <div className="flex items-center space-x-2 text-emerald-400 bg-emerald-500/5 rounded-lg p-3 border border-emerald-500/20">
      ...
      {/* Quick Actions */}
      <div className="p-4 border-t border-emerald-500/20 bg-black/40 space-y-4">
