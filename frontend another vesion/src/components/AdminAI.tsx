...
export function AdminAI() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-lg p-lg h-full">
      ...
      <div className="space-y-lg">
        ...
        <Card className="bg-black/30 border-emerald-500/20 overflow-hidden group hover:border-emerald-500/40 transition-colors duration-300">
          <div className="p-6">
            ...
            <div className="space-y-lg">
              <div className="flex items-center justify-between p-sm bg-emerald-500/5 rounded-lg border border-emerald-500/10">
