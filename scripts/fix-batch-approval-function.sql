-- Fixed batch approval function that properly distributes total received liters proportionally
-- among collections rather than applying the same value to each collection
