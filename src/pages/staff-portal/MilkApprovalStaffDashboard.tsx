...
const MilkApprovalStaffDashboard = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      path: "/milk-approval/variance-reports",
      color: "bg-orange-500"
    },
    {
      ...
      path: "/milk-approval/collector-performance",
      color: "bg-purple-500"
    }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-primary to-primary-light rounded-2xl p-6 text-primary-foreground shadow-lg">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-3xl font-bold">Welcome, Milk Approval Staff!</h1>
            <div className="text-primary-foreground/90 mt-2">
              Manage milk approvals, variances, and collector performance
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="border-l-4 border-l-green-500">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium text-muted-foreground">Today's Variance</div>
        ...
        <Card className="border-l-4 border-l-purple-500">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium text-muted-foreground">Active Collectors</div>
...
export default MilkApprovalStaffDashboard;