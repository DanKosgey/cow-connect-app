    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Manage system-wide and farmer-specific deductions
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        <Dialog open={showDeductionTypeDialog} onOpenChange={(open) => {
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>
                {editingDeductionType ? 'Edit Deduction Type' : 'Add Deduction Type'}
              </DialogTitle>
              <DialogDescription>
                {editingDeductionType 
                  ? 'Modify an existing deduction type' 
                  : 'Create a new deduction type for recurring deductions'}
              </DialogDescription>
            </DialogHeader>
        ...
        <Dialog open={showFarmerDeductionDialog} onOpenChange={(open) => {
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>
                {editingFarmerDeduction ? 'Edit Farmer Deduction' : 'Add Farmer Deduction'}
              </DialogTitle>
              <DialogDescription>
                {editingFarmerDeduction 
                  ? 'Modify an existing farmer deduction' 
                  : 'Set up a recurring deduction for a specific farmer'}
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
        ...
        <Dialog open={showImmediateDeductionDialog} onOpenChange={(open) => {
          ...
          <DialogTrigger asChild>
            <Button variant="destructive" onClick={() => {
              ...
              Immediate Deduction (All Farmers)
            </Button>
          </DialogTrigger>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>Apply Immediate Deduction</DialogTitle>
              <DialogDescription>
                Apply a one-time deduction to all farmers immediately
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleApplyImmediateDeduction} disabled={saving}>
                {saving ? 'Applying...' : 'Apply Deduction'}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="types" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure different types of deductions that can be applied
              </CardDescription>
            </CardHeader>
            <CardContent>
              {filteredDeductionTypes.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">No deduction types found</h3>
                  <p className="text-muted-foreground mb-4">
                    {searchTerm 
                      ? 'No deduction types match your search.' 
                      : 'Get started by adding a new deduction type.'}
                  </p>
                  <Button onClick={() => {
                    resetDeductionTypeForm();
                    setShowDeductionTypeDialog(true);
        ...
        <TabsContent value="farmer" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle>Farmer Deductions</CardTitle>
              <CardDescription>
                Specific deductions configured for individual farmers
              </CardDescription>
            </CardHeader>
            <CardContent>
              {filteredFarmerDeductions.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">No farmer deductions found</h3>
                  <p className="text-muted-foreground mb-4">
                    {searchTerm 
                      ? 'No farmer deductions match your search.' 
                      : 'Get started by adding a new farmer deduction.'}
                  </p>
                  <Button onClick={() => {
                    resetFarmerDeductionForm();
                    setShowFarmerDeductionDialog(true);
        ...
        <TabsContent value="records" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                History of all deductions applied to farmers
              </CardDescription>
            </CardHeader>
            <CardContent>
              {filteredDeductionRecords.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">No deduction records found</h3>
                  <p className="text-muted-foreground">
                    {searchTerm 
                      ? 'No deduction records match your search.' 
                      : 'Deduction records will appear here when deductions are applied.'}
                  </p>
                </div>
              )}
            </CardContent>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {itemToDelete?.type === 'deductionType' ? (
                <>
                  This action cannot be undone. This will permanently delete the deduction type
                  and all associated data.
                  {itemToDelete && (
                    <span className="block mt-2 font-medium">
                      Note: You can only delete deduction types that are not in use by farmers.
                    </span>
                  )}
                </>
              ) : (
                <>
                  This action cannot be undone. This will permanently delete the farmer deduction.
                </>
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
